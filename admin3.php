...
<body>
  ...
  <?php
		...
		move_uploaded_file($_FILES['photo']['tmp_name'],$pic);
		    ...
		    $query="insert into collegep(cname,city,cpara,photo,link) values('".$_POST['name']."','".$_POST['city']."','".$_POST['cpara']."','$pic','".$_POST['clink']."')";
				$result= mysqli_query($conn,$query);
					if($result)
					{
						echo"<script>alert('College uploaded Sucessfully..')</script>";
					}
					else {
