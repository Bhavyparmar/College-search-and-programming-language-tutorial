...
<head>
  ...
  <title>Blog upload Update </title>
  <link rel="stylesheet" href="./Admin side/vendors/bootstrap/bootstrap.min.css">
...
<body>
  ...
  <?php
		...
		move_uploaded_file($_FILES['photo']['tmp_name'],$pic);
				...
				$id=$_REQUEST['id'];
		        $query="update blog set title='".$_POST['title']."',date='".$_POST['date']."',para='".$_POST['cpara']."',link='".$_POST['clink']."',img='$pic' where id='$id'";
